...
import meta.state.RankingState;
...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		fuckingRank.frames = Paths.getSparrowAtlas('UI/default/ranks/${Init.trueSettings.get('Ranks Skin')}');
		...
		switch (curSong.toLowerCase()) {
			...
			scoreRequired = 224;
			case 'senpai':
			fuckingRank.frames = Paths.getSparrowAtlas('UI/default/ranks/pixel');
			scoreRequired = 200;
			case 'roses':
			fuckingRank.frames = Paths.getSparrowAtlas('UI/default/ranks/pixel');
			scoreRequired = 233;
