...
/**
	A new chart editor. Mainly focused on Psych Engine/Lullaby charting system
**/
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "LULLABY CHART v0.1.0", 12);
	...
	function addSongUI():Void
	{
		...
		var playerGFDropDown = new FlxUIDropDownMenu(10, 200, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true), function(character:String)
		{
		...
		var daStageDropDown = new FlxUIDropDownMenu(140, 200, FlxUIDropDownMenu.makeStrIdLabelArray(stages, true), function(character:String)
		{
			_song.curStage = stages[Std.parseInt(stages)];
		});
		daStageDropDown.selectedLabel = _song.curStage;

		var assetModifiers:Array<String> = CoolUtil.returnAssetsLibrary('UI/default');

		var assetModifierDropDown = new FlxUIDropDownMenu(player2DropDown.x, playerGFDropDown.y + 40,
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			note.lane = Std.int(Math.max(Math.floor(i[1]), 0));
			note.sustainLength = daSus;
			note.noteType = daNoteType;
			note.setGraphicSize(GRID_SIZE, GRID_SIZE);
			note.updateHitbox();
			note.x = Math.floor((daNoteInfo + (note.lane)) * GRID_SIZE);
